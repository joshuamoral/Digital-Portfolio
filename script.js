document.addEventListener("DOMContentLoaded", function () {
	...
	var lccaProjectSection = document.getElementById("lcca-project");
	...
	function updateHeaderActiveState() {
		...
		var mobileAppStart = mobileAppSection
			...
			: Number.POSITIVE_INFINITY;
		var lccaProjectStart = lccaProjectSection
			? lccaProjectSection.getBoundingClientRect().top + window.scrollY - 40
			: Number.POSITIVE_INFINITY;
		...
		if (
			...
			document.body.classList.add("lcca-nav-highlight");
		} else {
			document.body.classList.remove("lcca-nav-highlight");
		}
